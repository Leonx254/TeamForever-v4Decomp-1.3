...
bool disableFocusPause        = true;
bool disableFocusPause_Config = true;
...
void InitUserdata()
{
    ...
    if (!file) {
        ...
        if (!StrComp(Engine.dataFile[1], "")) {
            ini.SetString("Dev", "DataFile2", (char *)"ForceData2.rsdk");
            StrCopy(Engine.dataFile[2], "ForceData2.rsdk");
        }
        if (!StrComp(Engine.dataFile[2], "")) {
            ini.SetString("Dev", "DataFile3", (char *)"ForceData3.rsdk");
            StrCopy(Engine.dataFile[2], "ForceData3.rsdk");
        }
        if (!StrComp(Engine.dataFile[3], "")) {
            ini.SetString("Dev", "DataFile4", (char *)"ForceData4.rsdk");
            StrCopy(Engine.dataFile[3], "ForceData4.rsdk");
        }
        ...
        ini.SetBool("Game", "DisableFocusPause", disableFocusPause = true);
